...
/* Before using the hash table we must allocate memory for it.
 ...
 indexing as explained in the comment for the hash_search function.
  ...
  )
{
    ...
    {
        /* If table is full and another entry should be HASH_ENTERed then return with error. */
...
int 
hash_create(hash_table_s *htab, long nel)
{
    int ret;
...
ENTRY *
hash_search(hash_table_s *htab, ENTRY item, ACTION action)
{
    ENTRY *result;
